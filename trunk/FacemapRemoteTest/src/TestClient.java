 ...
 * 
 * Prereq's: Glassfish3 server on localhost started with the FacemapServerApp 
 * deployed to it
 * 
...
public class TestClient {
	...
	public void test() throws ClientAppException, NamingException {
		...
		ClientApp clientApp1 = new ClientAppImpl("FacemapServerApp", "FacemapEjb", "LoginServiceImpl");
		ClientApp clientApp2 = new ClientAppImpl("FacemapServerApp", "FacemapEjb", "LoginServiceImpl");
